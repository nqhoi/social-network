...
const CallModal = () => {
  ...
  }, [dispatch, answer, tracks, call, socket, addCallMessage]);
  ...
  useEffect(() => {
    socket.on('callerDisconnect', () => {
      ...
      dispatch({ type: GLOBALTYPES.CALL, payload: null });
      dispatch({ type: GLOBALTYPES.ALERT, payload: {error: `The ${call.username} disconnect`} });
    })

    return () => socket.off('callerDisconnect')
  },[socket, dispatch, tracks, addCallMessage, answer, total, call, newCall])
