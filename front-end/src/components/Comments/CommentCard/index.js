...
const CommentCard = ({ children, comment, post, commentId }) => {
  ...
  // event: user update comment
  const handleUpdate = () => {
    if (comment.conent !== content) {
  ...
  return (
    <div className="commentcard  mt-2" style={styleCard}>
          ...
          {onEdit ? (
            ...
            <div>
              ...
              {content.length > 100 && (
                ...
                >
                  {readMore ? "Hide cotent" : "Read more"}
                </span>
              )}
            </div>
          )}
